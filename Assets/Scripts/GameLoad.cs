...
public class GameLoad : MonoBehaviour
{
    ...
    void Update()
    {
        if (glass4.GetComponent<WindowScript>().isCleaned == true && licznik == 3)
        {
            glass4.SetActive(false);
            licznik++;
        }
        else if (glass1.GetComponent<WindowScript>().isCleaned == true && licznik == 0)
        {
        ...
        else if (glass2.GetComponent<WindowScript>().isCleaned == true && licznik == 1)
        {
        ...
        else if (glass3.GetComponent<WindowScript>().isCleaned == true && licznik == 2)
        {
